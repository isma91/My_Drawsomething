...
<head>
	...
	<script src="media/js/appInscriptionConnexion.js"></script>
<!--[if lt IE 9]>
...
<body>
	<div class="container">
		<h1 id="titre">My Drawsomething</h1>
		<img id="logo" src="media/logo.jpg" alt="logo">
	</div>
	<div class="container">
		<div class="jumbotron">
			<h2>Veuillez vous inscrire pour commencer à dessiner avec vos amis !!</h2>
			<div id="inscriptionSuccess"></div>
			<h3 id="erreur"></h3>
			<form id="formInscription" enctype="multipart/form-data">
				<div class="form-group">
					<input type="text" name="login" class="form-control" placeholder="Login">
				</div>
				<div class="form-group">
					<input type="password" name="password" class="form-control" placeholder="Pass minimum 5 caractères">
				</div>
				<div class="form-group">
					<input type="password" name="validPassword" class="form-control" placeholder="Re-entrer pass">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<button type="button" class="btn btn-primary form-control" name="valider" id="inscription">Inscription</button>
				</div>
			</form>
		</div>
		<div class="jumbotron">
			<h2>Deja inscrit ? Veullez vous connecter ici !!</h2>
			<form id="formConnexion" method="POST">
				...
				<div class="form-group">
					<button type="button" class="btn btn-primary form-control" name="connexion" id="connexion">Connexion</button>
				</div>
			</form>
		</div>
	</div>
